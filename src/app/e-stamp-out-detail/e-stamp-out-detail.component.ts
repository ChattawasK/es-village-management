...
@Component({
  selector: 'app-e-stamp-out-detail',
  templateUrl: './e-stamp-out-detail.component.html',
  styleUrls: ['./e-stamp-out-detail.component.scss']
})
export class EStampOutDetailComponent implements OnInit {
